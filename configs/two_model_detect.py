...
from utils.general import (
    check_img_size, non_max_suppression, cross_class_nms, apply_classifier, scale_coords,
...
checkpoint_file = data_root + '2021_7_33/latest.pth'
...
def detect(save_img=False):
    ...
    plt.yticks([])
    plt.axis([0, 640, 0, 480])
    plt.text(50, 420, f"Calming detection report", color='blue', size=10)
    ...
    plt.savefig('/AI/results/report.jpg')


if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--weights', nargs='+', type=str, default='super_yolo.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/AI/Calming_final_test/test', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--save-dir', type=str, default='/AI/Calming_final_test/results', help='directory to save results')
